      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
        <div className="col-span-7 place-self-center">
          ...
          <div className="flex gap-4 mt-3 text-center sm:text-left">
            <button className="font-semibold w-full sm:w-fit py-3 px-6 rounded-full bg-gradient-to-br from-blue-500 via-purple-500 to-pink-500 hover:bg-slate-200 text-white">
              Hire Me
            </button>
            <button className="font-semibold p-1  rounded-full w-full sm:w-fit bg-gradient-to-br from-blue-500 via-purple-500 to-pink-500 hover:bg-slate-900 text-white ">
